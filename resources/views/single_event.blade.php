        ...
        <div
            ...
            <div class="relative">
                <div class="w-full max-w-xl xl:w-full xl:mx-auto xl:pr-24 xl:max-w-xl">
                    <h3 class="text-4xl font-bold text-white"> {{$event->title}}</h3>
                    <ul class="grid grid-cols-1 mt-10 sm:grid-cols-2 gap-x-8 gap-y-4">
                        <li class="flex items-center space-x-3">
                            <div
                                class="inline-flex items-center justify-center flex-shrink-0  w-8 h-8   bg-gradient-to-b from-green-100 to-green-50  rounded-full">
                            ...
                            <span class="text-lg font-medium text-white">{{$event->date}} </span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <div
                                class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8  bg-gradient-to-b from-green-100 to-green-50  rounded-full">
                            ...
                            <span class="text-lg font-medium text-white"> {{$event->price}} DH</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <div
                                class="inline-flex items-center justify-center flex-shrink-0  w-8 h-8   bg-gradient-to-b from-green-100 to-green-50  rounded-full">
                            ...
                            <span class="text-lg font-medium text-white"> {{$event->localisation}}  </span>
                        </li>
                    </ul>
                </div>
            </div>
