...
@section('content')
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <div class="w-full px-6 py-6 mx-auto">
            <x-admin.statistics :usersCount="$usersCount" :eventCount="$eventCount" :reservationCount="$reservationCount" :mostReservedEvent="$mostReservedEvent" :mostReservedEventCount="$mostReservedEventCount"/>
