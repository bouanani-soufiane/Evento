<x-modals.modal modalId="event-create" modalTitle="Créer un événements" width="max-w-2xl">
    <form action="{{ route("events.store") }}" method="post" class="p-4 md:p-5 z-99 " enctype="multipart/form-data">
        @csrf
        <div class="flex flex-col gap-4 mb-4 ">
            ...
            <select id="reservation_type" name="category_id"
            ...
            <select id="reservation_type" name="reservationType"
                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
