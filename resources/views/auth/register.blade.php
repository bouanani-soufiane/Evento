<x-guest-layout>
    ...
    <div class="flex flex-wrap px-3 -mx-3  sm:px-6 xl:px-12 ">
        ...
        <div class="w-6/12 max-w-full px-1 mr-auto flex-0 justify-center ">
        ...
        <div class="relative w-full max-w-full px-3 mt-2 text-center shrink-0">
            <p class="z-20 inline  font-semibold leading-normal bg-white text-sm text-slate-400">OU</p>
        </div>
    </div>
